...
pub fn e256_add(c: &mut Criterion) {
    let one: [u8; 32] = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    c.bench_function("e256_add", |b| {
        b.iter(|| black_box((w, overflowing) = E256::overflowing_add_u(one, two)))
    });
}

pub fn e256_add_c_impl(c: &mut Criterion) {
    let one: [u8; 32] = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    c.bench_function("e256_add_c_impl", |b| {
        b.iter(|| black_box(overflowing = c_impl::add_256(&mut w, &one, &two)))
    });
}

pub fn e256_sub(c: &mut Criterion) {
    let one: [u8; 32] = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    let one = E256::get(&one[..]);
    let two = E256::get(&two[..]);
    c.bench_function("e256_sub", |b| {
        b.iter(|| black_box((w, overflowing) = E256::overflowing_sub_u(one, two)))
    });
}

pub fn e256_sub_c_impl(c: &mut Criterion) {
    let one: [u8; 32] = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    let mut w = [0u8; 32];
    let mut overflowing = 0u64;
    c.bench_function("e256_sub_c_impl", |b| {
        b.iter(|| black_box(overflowing = c_impl::sub_256(&mut w, &one, &two)))
    });
}
