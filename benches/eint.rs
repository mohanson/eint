...
pub fn e256_overflowing_add_ll(c: &mut Criterion) {
    let one = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    c.bench_function("e256_overflowing_add_ll", |b| {
        b.iter(|| black_box(overflowing = ll::overflowing_add_256(&mut w, &one, &two)))
    });
}
...
pub fn e256_overflowing_sub_ll(c: &mut Criterion) {
    let one = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    let mut w = [0u8; 32];
    let mut overflowing = 0u64;
    c.bench_function("e256_overflowing_sub_ll", |b| {
        b.iter(|| black_box(overflowing = ll::overflowing_sub_256(&mut w, &one, &two)))
    });
}
...
pub fn e256_widening_mul_u_ll(c: &mut Criterion) {
    let one = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    let mut w = [0u8; 64];
    c.bench_function("e256_widening_mul_u_ll", |b| b.iter(|| black_box(ll::widening_mul_u_256(&mut w, &one, &two, 1))));
}
...
pub fn e256_wrapping_mul_ll(c: &mut Criterion) {
    let one = [
        0xf4, 0x73, 0x3e, 0x02, 0x88, 0x77, 0x2f, 0xb1, 0xd2, 0x29, 0x8d, 0x0e, 0xa7, 0xa5, 0xaa, 0xe2, 0xb6, 0xd8,
        0xd2, 0x91, 0xf8, 0x81, 0xf2, 0x01, 0xb3, 0x23, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    let mut w = [0u8; 32];
    c.bench_function("e256_wrapping_mul_ll", |b| b.iter(|| black_box(ll::wrapping_mul_256(&mut w, &one, &two, 1))));
}
...
criterion_group!(
    ...
    e256_overflowing_add_ll,
    e256_overflowing_sub,
    e256_overflowing_sub_ll,
    e256_widening_mul_u,
    e256_widening_mul_u_ll,
    e256_wrapping_div_s,
    e256_wrapping_div_u,
    e256_wrapping_mul,
    e256_wrapping_mul_ll,
    e256_wrapping_rem_s,
    e256_wrapping_rem_u,
);
